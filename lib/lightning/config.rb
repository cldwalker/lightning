...
module Lightning
  ...
  # * *:complete_regex*: true or false (default is true). When set, Ruby regular expressions can be used while
  #   completing to match possible completions. For duplicate paths that offer their full paths in completion,
  #   this means their full paths can also match. One non-regexp shorthand is that a '*' is converted to '.*'
  #   for glob-like behavior. 
