...
#   $0 dir.rb ~/apps ~/temp
#
# Or in the config file lightning.yml and then reference the key of config hash:
#   $0 -k code dir.rb
#
...
def parse_argv
  options = {}
	...
	opts.on("-k", "--key=key", String, "sets directories to key found in lightning.yml") {|options[:key]|}
	 opts.on("-h", "--help",
